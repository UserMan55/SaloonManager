...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            "inline-flex h-12 items-center gap-1 rounded-xl bg-slate-800/50 p-1 border border-slate-700/50",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.Trigger
        ref={ref}
        className={cn(
            "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg px-4 py-2 text-sm font-medium text-slate-400 transition-all duration-200",
...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.Content
        ref={ref}
        className={cn(
            "mt-6 focus-visible:outline-none animate-fadeIn",
            className
        )}
        {...props}
    />
